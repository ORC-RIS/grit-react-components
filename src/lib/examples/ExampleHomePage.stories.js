...
const ExampleHomePageMainContent = ({ chidren }) => {
    const config = {
        ...
        pageContent: {
            sidebar: <ExampleHomePageSidebar />,
        },
    };
                ...
                <div className="card mb-4">
                    ...
                    <div className="card-block">
                        ...
                        <p className="card-text">
                            ...
                            elit. Reiciendis aliquid atque, nulla? Quos cum ex
                            quis soluta, a laboriosam. Dicta expedita corporis
                            animi vero voluptate voluptatibus possimus, veniam
                            magni quis!
                        </p>
...
const ExampleHomePageSidebar = ({ config = {} }) => {
    return (
        <>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <ul className="list-unstyled mb-0">
                                ...
                                <li>
                                    <a href="#navigablenavigable">Pundamlia</a>
                                </li>
                            </ul>
                        </div>
                    </div>
